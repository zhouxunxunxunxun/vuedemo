...
export default {
    ...
    created() {
      this.$axios.get("http://222.24.63.61:8080/apply/query_paidui2").then((res)=>{
        for(let i = 0;i < res.data.length;i++){
          this.$axios.post("http://222.24.63.61:8080/apply/query_apply22",{cno:res.data[i].cno}).then((res1)=>{
            this.str = res.data[i];
